...
//         let components =  [
//            VisualInstruction.Component(type: .image, text: "US 101", imageURL: ShieldImage.us101.url, abbreviation: nil, abbreviationPriority: 0),
//            VisualInstruction.Component(type: .delimiter, text: "/", imageURL: nil, abbreviation: nil, abbreviationPriority: 0),
//            VisualInstruction.Component(type: .image, text: "I 280", imageURL: ShieldImage.i280.url, abbreviation: nil, abbreviationPriority: 0)
//        ]
//        return components
//    }()
//    
//    lazy var genericInstructions: [VisualInstruction.Component] = [
//        VisualInstruction.Component(type: .image, text: "ANK 1", imageURL: nil, abbreviation: nil, abbreviationPriority: NSNotFound),
//        VisualInstruction.Component(type: .text, text: "Ankh-Morpork Highway 1", imageURL: nil, abbreviation: nil, abbreviationPriority: NSNotFound)
//    ]
// 
//    lazy var typicalInstruction: VisualInstructionBanner = makeVisualInstruction(primaryInstruction: [VisualInstruction.Component(type: .text, text: "Main Street", imageURL: nil, abbreviation: "Main St", abbreviationPriority: 0)], secondaryInstruction: nil)
//    
...
//        let instruction1 = VisualInstruction.Component(type: .image, text: "I 280", imageURL: ShieldImage.i280.url, abbreviation: nil, abbreviationPriority: 0)
//        let instruction2 = VisualInstruction.Component(type: .image, text: "US 101", imageURL: ShieldImage.us101.url, abbreviation: nil, abbreviationPriority: 0)
//
...
//        let exitAttribute = VisualInstruction.Component(type: .exit, text: "Exit", imageURL: nil,  abbreviation: nil, abbreviationPriority: 0)
//        let exitCodeAttribute = VisualInstruction.Component(type: .exitCode, text: "123A", imageURL: nil, abbreviation: nil, abbreviationPriority: 0)
//        let mainStreetString = VisualInstruction.Component(type: .text, text: "Main Street", imageURL: nil, abbreviation: "Main St", abbreviationPriority: 0)
